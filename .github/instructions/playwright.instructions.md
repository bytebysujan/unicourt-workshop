...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, non-obvious interactions, or the reason a less-obvious assertion is required; never restate the test step.
