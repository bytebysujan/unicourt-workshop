...
- Comment only the reason a fixture or assertion is unusual; test names and setup should explain ordinary mechanics.
- Keep test comments current with the behavior they justify, and remove comments that merely describe the next assertion.
